 ...
 */
public class GetBuildingByIdTask extends AsyncTask<String, Void, Building> {
    @Override
    ...
    private Building deserializeCoordinate(String urlString) throws IOException {
    ...
    protected String getURL(String id) {
        return Constants.CONNECTION_PROTOCOL + Constants.COLON_AND_TWO_SLASHES + Constants.IP + Constants.COLON +
                Constants.PORT + Constants.SLASH_RESOURCES_SLASH + Constants.BUILDING + Constants.QUESTION_MARK_ID_EQUALS + id;
    }
}